...
const envSchema = z.object({
  ...
  PUBLIC_LEADS_SHARED_KEY: z.string().optional(),
  PUBLIC_LEADS_SIGNING_SECRET: z.string().optional(),
  PUBLIC_LEADS_ALLOWED_ORIGIN: z.string().url().optional(),
  PUBLIC_LEADS_TIMESTAMP_TOLERANCE_SECONDS: z.coerce.number().default(300),
...
const parsedEnv = envSchema.safeParse({
  ...
  PUBLIC_LEADS_SHARED_KEY: process.env.PUBLIC_LEADS_SHARED_KEY,
  PUBLIC_LEADS_SIGNING_SECRET: process.env.PUBLIC_LEADS_SIGNING_SECRET,
  PUBLIC_LEADS_ALLOWED_ORIGIN: process.env.PUBLIC_LEADS_ALLOWED_ORIGIN,
  PUBLIC_LEADS_TIMESTAMP_TOLERANCE_SECONDS:
    process.env.PUBLIC_LEADS_TIMESTAMP_TOLERANCE_SECONDS,
